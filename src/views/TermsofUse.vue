  ...
  <div class="termsofuse">
    ...
    <v-main>
      ...
      <v-card class="ma-3" elevation="0">
        <h1>利用規約</h1>
        <p>この利用規約（以下，「本規約」といいます。）は，kashu（以下，「当方」といいます。）がこのウェブサイト上で提供するサービス「Classroom Notifier」（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
        <h2>第1条（適用）</h2>
        <p>
        ...
        <h2>第2条（利用登録）</h2>
        <p>
          本サービスにおいては，登録希望者が本規約に同意の上，トップページの「ログイン/新規登録」を押下し当方サーバーのレスポンス(ステータスコード200)の送信を持って利用登録が完了するものとします。
        ...
        <p>なお、不具合やバグを発見した際は、速やかにGithubのIssueもしくはホームページのお問い合わせより連絡することとします。ただし、重大なセキュリティに関する脆弱性の場合はホームページのお問い合わせから連絡することとします。</p>
        ...
        <p>
          <ul>
            ...
            <li>本サービスについて，最終のログインから一定期間利用がない場合</li>
